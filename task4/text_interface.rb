class TextInterface
  ...
  def main
    ...
    puts "6: Добавление вагона."
    puts "7: Удаление вагона."
  ...
  def add_carriage_to_train
    train = select_train
    train.add_carriage(PassengerCarriage.new) if train.class == PassengerTrain
    train.add_carriage(CargoCarriage.new) if train.class == CargoTrain
  end
